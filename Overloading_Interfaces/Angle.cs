    ...
    struct Angle : IComparable, IEnumerable
    {
        ...
        public static Angle operator -(Angle a, Angle b)
        {
            ...
            if ((a.degrees == 0) && (a.minutes == 0) && (a.seconds == 0))
            {
                ...
                final_angle.minutes = (-1)*b.minutes;
                final_angle.seconds = (-1)*b.seconds;
            }
            else
            {
        ...
        {
            var result = Math.Abs(a.minutes - b.minutes) < epsilon &&
                Math.Abs(a.degrees - b.degrees) < epsilon &&
                Math.Abs(a.seconds - b.seconds) < epsilon;
